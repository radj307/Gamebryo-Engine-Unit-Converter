...
public:
	...
	int iGet(std::string&& header, std::string&& key)
	{
		return str::stoi(get(std::forward<std::string>(header), std::forward<std::string>(key)));
	}

	float fGet(std::string&& header, std::string&& key)
	{
		return str::stof(get(std::forward<std::string>(header), std::forward<std::string>(key)));
	}

	bool bGet(std::string&& header, std::string&& key)
	{
		auto v{ get(std::forward<std::string>(header), std::forward<std::string>(key)) };
